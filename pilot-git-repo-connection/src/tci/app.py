...
from tci.api.routes.workspaces import router as workspaces_router
...
from tci.web.routes.workspaces import router as workspaces_web_router
...
def create_app(
    *,
    ...
    app.include_router(workspaces_web_router)
