...
- 실행 환경과 내부 컴포넌트는 Node로 승격하지 않는다
...
```md
## public
- 포함 Node: Web Application

## private
- 포함 Node: Data Collection, Data Processing, Analysis Engine, Interactive Assistant, Workflow & Integration, Operations Manager
