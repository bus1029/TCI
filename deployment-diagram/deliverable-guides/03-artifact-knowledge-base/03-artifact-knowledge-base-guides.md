...
| Metadata Artifact | Knowledge Base Node | 정형 메타데이터 저장 | 내부 Artifact | data |
```
...
- 필요 시 내부에는 Runtime Environment를 중첩하고 Graph, Vector, Object, Metadata Artifact를 구분
...
| Relational Store | RDB Runtime | 내부 Artifact | 예 | 정형 메타데이터와 운영성 정보 저장 |
